...
with DAG(
    ...
    # Capture SCD2 deltas against the currently-seeded customers_latest /
    # orders_latest tables. Must run after seed and before any staging model
    # because stg_customers / stg_orders read from the snapshot outputs.
